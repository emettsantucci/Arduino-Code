#ifndef _ROS_manual_MovementFeedback_h
#define _ROS_manual_MovementFeedback_h
...
namespace manual
{
  ...
  class MovementFeedback : public ros::Msg
  {
    ...
    const char * getType(){ return "manual/MovementFeedback"; };
    const char * getMD5(){ return "2c1d00fb8b4e78420f43d93d5292a429"; };
